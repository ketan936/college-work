...
{	Trans *T;
	...
	trans[2][1]	= settr(4,0,2,3,3,"(run hello())", 0, 2, 0);
	trans[2][2]	= settr(5,0,3,4,4,"(run world())", 0, 2, 0);
	trans[2][3]	= settr(6,0,0,5,5,"-end-", 0, 3500, 0);

	/* proctype 1: world */

	trans[1] = (Trans **) emalloc(3*sizeof(Trans *));

	trans[1][1]	= settr(2,0,2,6,0,"printf('world\\n')", 0, 2, 0);
	trans[1][2]	= settr(3,0,0,7,7,"-end-", 0, 3500, 0);

	/* proctype 0: hello */

	trans[0] = (Trans **) emalloc(3*sizeof(Trans *));

	trans[0][1]	= settr(0,0,2,8,0,"printf('hello\\n')", 0, 2, 0);
	trans[0][2]	= settr(1,0,0,9,9,"-end-", 0, 3500, 0);
	/* np_ demon: */
