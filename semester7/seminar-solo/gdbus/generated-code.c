...
example_object_proxy_class_init (ExampleObjectProxyClass *klass)
{
  ...
  g_object_class_override_property (gobject_class, 3, "animal");
  g_object_class_override_property (gobject_class, 4, "cat");
  g_object_class_override_property (gobject_class, 5, "animal");
  g_object_class_override_property (gobject_class, 6, "cat");
  g_object_class_override_property (gobject_class, 7, "animal");
  g_object_class_override_property (gobject_class, 8, "cat");
  g_object_class_override_property (gobject_class, 9, "animal");
  g_object_class_override_property (gobject_class, 10, "cat");
}
