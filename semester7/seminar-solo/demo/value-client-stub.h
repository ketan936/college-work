...

{
  ...
  return dbus_g_proxy_begin_call (proxy, "getvalue1", org_maemo_Value_getvalue1_async_callback, stuff, _dbus_glib_async_data_free, G_TYPE_INVALID);
}
static
#ifdef G_HAVE_INLINE
inline
...

{
  ...
  stuff->cb = G_CALLBACK (callback);
  stuff->userdata = userdata;
  return dbus_g_proxy_begin_call (proxy, "getvalue2", org_maemo_Value_getvalue2_async_callback, stuff, _dbus_glib_async_data_free, G_TYPE_INVALID);
}
static
#ifdef G_HAVE_INLINE
inline
...

{
  ...
  stuff->cb = G_CALLBACK (callback);
  stuff->userdata = userdata;
  return dbus_g_proxy_begin_call (proxy, "setvalue1", org_maemo_Value_setvalue1_async_callback, stuff, _dbus_glib_async_data_free, G_TYPE_INT, IN_new_value, G_TYPE_INVALID);
}
static
#ifdef G_HAVE_INLINE
inline
...

{
  ...
  stuff->cb = G_CALLBACK (callback);
  stuff->userdata = userdata;
  return dbus_g_proxy_begin_call (proxy, "setvalue2", org_maemo_Value_setvalue2_async_callback, stuff, _dbus_glib_async_data_free, G_TYPE_DOUBLE, IN_new_value, G_TYPE_INVALID);
}
